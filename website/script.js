...
const leftSidebar = new Sidebar(document.getElementById('sidebar-l'), document.getElementById('toggle-l'), 0, 20);
...
let simulation = new Simulation(simParams, forceParams, mouse, container, leftSidebar, rightSidebar);
